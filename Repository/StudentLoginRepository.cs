    ...
    public class StudentLoginRepository : IStudentLoginRepository
    {
        ...
        public async Task<bool> RegisterStudent(StudentLogin studentLogin)
        {
            try
            {
                ...
                studentLogin.Token = Guid.NewGuid();
        ...
        public async Task<PersonalDetails?> GetPersonalDetails(Guid studentId)
        {
            try
            {
        ...
        public async Task<ParentsDetails?> GetParentsDetails(Guid studentId)
        {
            try
            {
